/******************************************************************************
 * RPC Client of GPS HAL (hardware abstraction layer) for HTC Liberty
 * 
 * leo-gps-rpc.c
 * 
...
#define  LOG_TAG  "gps_liberty_rpc"
...
int init_liberty() 
{
    struct CLIENT *clnt=clnt_create(NULL, 0x3000005b, 0xa60286b0, NULL);
    struct CLIENT *clnt_atl=clnt_create(NULL, 0x3000001d, 0xba845703, NULL);
    int i;
    _clnt=clnt;
    SVCXPRT *svc=svcrtr_create();
    _svc=svc;
    xprt_register(svc);
    svc_register(svc, 0x3100005b, 0xa60286b0, (__dispatch_fn_t)dispatch, 0);
    svc_register(svc, 0x3100005b, 0, (__dispatch_fn_t)dispatch, 0);
    svc_register(svc, 0x3100001d, 0xba845703, (__dispatch_fn_t)dispatch, 0);
...
void cleanup_gps_rpc_clients() 
{
    ...
    svc_unregister(_svc, 0x3100005b, 0xa60286b0);
    svc_unregister(_svc, 0x3100005b, 0);
    svc_unregister(_svc, 0x3100001d, 0xba845703);
